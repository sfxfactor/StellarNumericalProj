...
plt.plot(np.log10(TeffL1),np.log10(Ledd/Lsun),"D-",label="Pop III Edd")
plt.plot(np.log10(Teff1),np.log10(Ledd/Lsun),"D-",label="Pop III Eq 6")
plt.plot(np.log10(TeffL2),np.log10(Ledd/Lsun),"D-",label="Pop I Edd")
plt.plot(np.log10(Teff2),np.log10(Ledd/Lsun),"D-",label="Pop I Eq 6")
plt.legend(loc=9)
